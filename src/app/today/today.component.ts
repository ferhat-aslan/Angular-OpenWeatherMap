...
timeline:any=[];
initialCity={lat:37,long:37}
location:any={lat:undefined,long:undefined};
weatherNow:any;
currentTime=new Date();
  ...
  getTodayForecast(gelenJson:any){
    console.log("ferf",gelenJson)
    this.location = gelenJson.city;
    for(const forecast of gelenJson.list.slice(0,8)){
      this.timeline.push({
